...
ROOT_URLCONF = 'bythepong_web.urls'
...
# Database - Usar SQLite por padrão para desenvolvimento local
DATABASES = {
    'default': {
...
# Usar PostgreSQL apenas se especificado
if os.environ.get('USE_POSTGRES', 'false').lower() == 'true':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('POSTGRES_DB', 'bythepong'),
